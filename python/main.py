...
class CGConvertorApp(BASE_CLASS):
    ...
    def _setup_style(self):
        ...
        make_button_style("Accent.TButton", th["accent"], "#141414", th["accent_hover"])
    ...
    def _build_ui(self):
        ...
        for code in ("ro", "en", "es"):
            ttk.Button(lang_frame, text=code.upper(), width=3,
                       command=lambda c=code: self._set_language(c),
                       style="Lang.TButton", cursor="hand2").pack(side="left", padx=2)
