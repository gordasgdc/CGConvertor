...
/// Verifies GDC-format license serials — copiat byte-for-byte din
/// GDCVault/DataMover (`LicenseCore.swift`), acelasi format și aceeași
/// cheie publică Ed25519 partajată de tot ecosistemul GDC, ca orice cod
/// generat din Furnizor (`GenerateSerialView.swift`,
/// `gdcStandaloneProducts`) să funcționeze aici neschimbat.
///
...
public enum LicenseCore {
    ...
    /// keygen.py — identică în toate aplicațiile GDC. Sigur de distribuit
    /// (doar cheia privată, niciodată prezentă aici, poate genera coduri noi).
