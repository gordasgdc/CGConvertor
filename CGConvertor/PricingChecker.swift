...
/// `pricing.json` (publicat de Furnizor, `PricingManagerView`, în
/// `gdc-plugin-manager-catalog-vendor`, servit static la
/// `https://gordas.dev/pricing.json`) în loc de suma hardcodată din
/// `Localization.swift`. Fail-open, ca RevocationCheck (Regula 12): fără
/// conexiune sau `productID` lipsă din `pricing.json`, se folosește
/// `fallbackBasePrice` (23 €, valoarea hardcodată anterior).
