...
enum L {
    ...
    private static let table: [String: [AppLanguage: String]] = [
        ...
        "license.note": [.ro: "Licență Lifetime — donație unică, nu un preț de listă. Mă ajută să acopăr costurile de dezvoltare.",
                          .en: "Lifetime license — a one-time donation, not a list price. It helps cover development costs.",
                          .es: "Licencia Lifetime — donación única, no un precio de lista. Ayuda a cubrir los costos de desarrollo."],
