...
enum L {
    ...
    private static let table: [String: [AppLanguage: String]] = [
        ...
        "presets.colorSpace": [.ro: "Spațiu de culoare (etichetă)", .en: "Color space (tag)", .es: "Espacio de color (etiqueta)"],
        "presets.colorSpace.unchanged": [.ro: "Nemodificat", .en: "Unchanged", .es: "Sin cambios"],
        "colorSpace.bt709": [.ro: "Rec.709 (SDR standard)", .en: "Rec.709 (standard SDR)", .es: "Rec.709 (SDR estándar)"],
        "colorSpace.bt2020": [.ro: "Rec.2020 (gamut extins/HDR)", .en: "Rec.2020 (wide gamut/HDR)", .es: "Rec.2020 (gama amplia/HDR)"],
        ...
        "offload.volumes.dragHint": [.ro: "Trage un disc peste Sursă/Destinații, sau folosește butoanele.", .en: "Drag a disk onto Source/Destinations, or use the buttons.", .es: "Arrastra un disco sobre Origen/Destinos, o usa los botones."],

        // ── Producție/branding, șablon de nume, card cameră, profile, istoric (port DataMover, Etapa 2026-09-03) ──
        "offload.production.title": [.ro: "Producție", .en: "Production", .es: "Producción"],
        "offload.production.project": [.ro: "Proiect", .en: "Project", .es: "Proyecto"],
        "offload.production.card": [.ro: "Card", .en: "Card", .es: "Tarjeta"],
        "offload.production.client": [.ro: "Client", .en: "Client", .es: "Cliente"],
        "offload.production.camera": [.ro: "Cameră", .en: "Camera", .es: "Cámara"],
        "offload.production.operator": [.ro: "Operator / DIT", .en: "Operator / DIT", .es: "Operador / DIT"],
        "offload.production.notes": [.ro: "Note", .en: "Notes", .es: "Notas"],
        "offload.production.logo": [.ro: "Logo raport", .en: "Report logo", .es: "Logo del informe"],
        "offload.production.chooseLogo": [.ro: "Alege…", .en: "Choose…", .es: "Elegir…"],
        "offload.production.clearLogo": [.ro: "Șterge", .en: "Clear", .es: "Quitar"],
        "offload.naming.title": [.ro: "Șablon nume folder", .en: "Folder naming template", .es: "Plantilla de nombre de carpeta"],
        "offload.naming.preview": [.ro: "Previzualizare", .en: "Preview", .es: "Vista previa"],
        "offload.card.warnings": [.ro: "Atenție", .en: "Warning", .es: "Atención"],
        "offload.card.parentWarning": [.ro: "Pare un SUBFOLDER al unui card (%@) — sursa mai sus ar putea pierde metadate ale cardului complet.", .en: "Looks like a SUBFOLDER of a card (%@) — the source above may miss metadata from the full card.", .es: "Parece un SUBCARPETA de una tarjeta (%@) — el origen de arriba podría perder metadatos de la tarjeta completa."],
        "offload.profiles.title": [.ro: "Profile de transfer", .en: "Transfer profiles", .es: "Perfiles de transferencia"],
        "offload.profiles.save": [.ro: "Salvează profil…", .en: "Save profile…", .es: "Guardar perfil…"],
        "offload.profiles.load": [.ro: "Încarcă", .en: "Load", .es: "Cargar"],
        "offload.profiles.namePrompt": [.ro: "Nume profil", .en: "Profile name", .es: "Nombre del perfil"],
        "offload.history.button": [.ro: "Istoric", .en: "History", .es: "Historial"],
        "history.title": [.ro: "Istoric offload", .en: "Offload history", .es: "Historial de offload"],
        "history.clearAll": [.ro: "Șterge tot", .en: "Clear all", .es: "Borrar todo"],
        "history.clearAllConfirm": [.ro: "Ștergi tot istoricul?", .en: "Clear all history?", .es: "¿Borrar todo el historial?"],
        "history.empty": [.ro: "Niciun offload înregistrat încă.", .en: "No offload recorded yet.", .es: "Aún no hay ningún offload registrado."],
        "history.source": [.ro: "Sursă", .en: "Source", .es: "Origen"],
        "history.destination": [.ro: "Destinație", .en: "Destination", .es: "Destino"],
        "history.ok": [.ro: "OK", .en: "OK", .es: "OK"],
        "history.mismatch": [.ro: "Nepotriviri", .en: "Mismatches", .es: "Discrepancias"],
        "history.errors": [.ro: "Erori", .en: "Errors", .es: "Errores"],
        ...
        "compare.parameter": [.ro: "Parametru", .en: "Parameter", .es: "Parámetro"],
        "compare.search": [.ro: "Caută…", .en: "Search…", .es: "Buscar…"],
        "compare.highlightDiffs": [.ro: "Evidențiază diferențele", .en: "Highlight differences", .es: "Resaltar diferencias"],
        "compare.hideIdentical": [.ro: "Ascunde identice", .en: "Hide identical", .es: "Ocultar idénticas"],
        "compare.exportCsv": [.ro: "Exportă CSV", .en: "Export CSV", .es: "Exportar CSV"],
        ...
        "offload.status.doneWithRecovered": [.ro: "Gata — OK: %d · Nepotriviri: %d · Erori: %d · Recuperate la reîncercare: %d", .en: "Done — OK: %d · Mismatches: %d · Errors: %d · Recovered on retry: %d", .es: "Listo — OK: %d · Discrepancias: %d · Errores: %d · Recuperados al reintentar: %d"],
        "offload.status.insufficientSpace": [.ro: "Spațiu insuficient pe „%@” — necesare %@, disponibile %@.", .en: "Not enough space on “%@” — needed %@, available %@.", .es: "Espacio insuficiente en «%@» — se necesitan %@, disponibles %@."],
        "offload.log.retrying": [.ro: "Reîncerc %d fișier(e) care au eșuat…", .en: "Retrying %d failed file(s)…", .es: "Reintentando %d archivo(s) fallido(s)…"],
